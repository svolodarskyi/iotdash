...
| `.github/workflows/soak-deploy.yml` | CI/CD: build images, push to GHCR, deploy to VM |
...
1. Set repository secrets: `SOAK_VM_HOST`, `SOAK_VM_SSH_KEY`
2. Run the `Soak Test — Build & Deploy` workflow manually
3. Images build, push to GHCR, deploy to VM automatically
