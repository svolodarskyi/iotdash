        ...
        <div className="mb-6 p-4 bg-white rounded-lg border border-gray-200">
          ...
          <div className={isMobile ? 'space-y-2' : 'flex gap-2'}>
            ...
            <div className={isMobile ? 'flex gap-2' : 'contents'}>
              <button onClick={handleCreate} className="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 min-h-[44px] flex-1 md:flex-none">
                Save
              </button>
              <button onClick={() => { setShowCreate(false); setNewName('') }} className="px-4 py-2 text-sm text-gray-600 hover:text-gray-800 min-h-[44px] flex-1 md:flex-none">
                Cancel
              </button>
            </div>
          </div>
